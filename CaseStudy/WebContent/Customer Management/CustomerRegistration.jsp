...
<%} %>
<<<<<<< .mine
	<form action="<%=request.getContextPath()%>/Controller" class="form"  method="post" enctype="multipart/form-data">
  				
  				<input type="file" name="file" size="50">
 				
 				<%
 				HttpSession sessionn = request.getSession(true);
 				session.setAttribute("action1", "SubmitFile"); 
 				%>
 				
 				<input type="submit"  value="SubmitFile" class="button">
	</form>	
