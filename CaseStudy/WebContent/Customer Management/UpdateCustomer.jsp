...
<%} %>	
	...
	<div id="container" style="height: 200px;">
		...
		<form  action="<%=request.getContextPath()%>/Controller" name="updateCustomer" method="post" onsubmit="return validateNum(document.updateCustomer.customerId)">
		
		
			<label for="customerId">ENTER THE CUSTOMER ID TO BE UPDATED<font color="red"><b> *</b></font></label> 
...
sessionn.setAttribute("custAction", "searchCustomer");
