...
<title>View Customers In Date</title>
</head>
<body>
...
<div id="container" style="height: 230px;">
		...
		<form  action="<%=request.getContextPath()%>/Controller" name="viewCustomer" method="post" onsubmit="return validateDates(document.viewCustomer.date1,document.viewCustomer.date2);">
		
			<label for="date1">ENTER THE RANGE OF DATES <font color="red">DD/MM/YYYY</font></label>
			
			
			<input type="name" name="date1" id ="date1"></input>
			<input type="name" name="date2" id ="date2"></input>
...
sessionn.setAttribute("custAction", "viewCustomerDate");
%>
