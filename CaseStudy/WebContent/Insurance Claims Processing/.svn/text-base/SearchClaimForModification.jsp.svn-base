...
<title>Modification of Claim</title>
</head>
<body>
<% 
...
<% 
   ...
   if(request.getAttribute("msg")!=null)
   {
    ...
    hsession.setAttribute("claimAction", "getClaimDetailsForModification"); 
    %>

<div id="container" style="height: 200px;">
		
		<form  action="<%=request.getContextPath()%>/ClaimController" name="modifyClaim" method="post"">
