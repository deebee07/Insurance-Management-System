...
<a href="<%=request.getContextPath()%>/LoginController">LOG OUT</a>
	...
	<div class="body body-s">
		...
		<%
			...
			hsession.setAttribute("healthAction", "viewHealthPolicy");
		%>

		<center>
			<h1>HEALTH INSURANCE POLICY DETAILS</h1>
		</center>
		<div id="container" style="height: 200px;">

			<form action="<%=request.getContextPath()%>/PolicyController"
				name="viewHealthPolicy" method="post"
				onsubmit="return viewValidate();">


				<label for="ID">ENTER CUSTOMER ID:<font color="red"><b>*</b></font></label>
				<input type="name" name="id" id="ID"
					onblur="return validateNum(document.viewHealthPolicy.id)"
					required>


				<div id="lower">
					<input type="hidden" name="action" value="viewHealthPolicy">
