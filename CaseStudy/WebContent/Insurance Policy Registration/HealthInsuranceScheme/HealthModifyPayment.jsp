...
<title>Health Insurance Modification</title>
</head>
...
<body class="bg-cyan">
	...
	<div class="body body-s">
		...
		<%
			...
			hsession.setAttribute("healthAction", "modifyHealthPolicy");
		%>
		<form action="<%=request.getContextPath()%>/PolicyController"
			name="modifyHealthPolicy" method="post"
			onsubmit="return modifyHealth(ID, PID, pMode, pFrequency);"
			class="form">

			<fieldset>
				<header> Health Insurance Policy Modification form</header>
				...
				<section> <label class="input" for="ID"> <i
					...
					onblur="return ValidatePolicyRefNum(document.modifyHealthPolicy.ID)">
				...
				<section> <label class="select" for="pMode"> <i
					...
					onblur="return validatePaymentMode()">
				...
				<section> <label class="select" for="pFrequency">
					...
					id="pFrequency" onblur="return validatePaymentFrequency()">
				...
				<footer> <input type="hidden" name="action"
					value="modifyHealthPolicy"> <input type="submit"
