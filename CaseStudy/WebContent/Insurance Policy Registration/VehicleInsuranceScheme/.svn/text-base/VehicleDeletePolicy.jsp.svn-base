...
<title>Vehicle Insurance Deletion</title>
</head>
...
<a href="<%=request.getContextPath()%>/LoginController">LOG OUT</a>
	...
	<div class="body body-s">
		...
		<%
			...
			hsession.setAttribute("healthAction", "deleteVehiclePolicy");
		%>
		<center>
			<h1>DELETE VEHICLE INSURANCE POLICY</h1>
		</center>
		<div id="container" style="height: 200px;">

			<form action="<%=request.getContextPath()%>/PolicyController"
				name="deleteVehiclePolicy" method="post"
				onsubmit="return deleteHealthUsingPolicyRefNum(PID)">


				<label for="PID">ENTER POLICY REFERENCE NUMBER:<font
					color="red"><b> *</b></font></label> <input type="name" name="PID" id="PID"
					onblur="return ValidatePolicyRefNum(document.deleteVehiclePolicy.PID)">


				<div id="lower">
					<input type="hidden" name="action" value="deleteVehiclePolicy">
