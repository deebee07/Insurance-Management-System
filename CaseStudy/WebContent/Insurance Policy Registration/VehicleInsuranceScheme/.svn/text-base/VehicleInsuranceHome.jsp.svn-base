...
<a href="<%=request.getContextPath()%>/LoginController">LOG OUT</a>
	...
	<div class=content>
		<h1>VEHICLE POLICY REGISTRATION</h1>
		<br> <br> <br> <a
			href="../../Insurance Policy Registration/VehicleInsuranceScheme/VehicleInsuranceRegistration.jsp"
			class="btn btn--gray-dark">REGISTRATION OF VEHICLE POLICY FOR A
			CUSTOMER</a> <a
			href="../../Insurance Policy Registration/VehicleInsuranceScheme/VehicleModifyPayment.jsp"
			class="btn btn--gray-dark">MODIFICATION OF VEHICLE POLICY DETAILS</a>
		<a
			href="../../Insurance Policy Registration/VehicleInsuranceScheme/VehicleDeletePolicy.jsp"
			class="btn btn--gray-dark">TERMINATION OF VEHICLE POLICY</a> <a
			href="../../Insurance Policy Registration/VehicleInsuranceScheme/VehicleViewDetails.jsp"
			class="btn btn--gray-dark">VIEW VEHICLE POLICY</a>
